export const STATUSES = ["Inquiry","Quote Approved","Deposit Paid","Material Check","Production","Quality Control","Ready for Delivery","Partially Delivered","Delivered","Closed","Cancelled / Refunded"];
...
export const ALL_STATUS_COLORS = {
  ...
  "Cancelled / Refunded":{bg:"#FFF1F2",text:"#9F1239",border:"#FDA4AF"},
...
export const CHARGE_TYPES = ["Delivery Fee","Design Fee","Installation Fee","Packaging","Other Charge"];
...
export const ROLES_CAN_CREATE = ["admin","production_manager","head_of_sales","sales"];
export const ROLES_CAN_EDIT = ["admin","production_manager","head_of_sales","sales"];
export const ROLES_CAN_ADVANCE = ["admin","production_manager","head_of_sales","production_staff","sales"];
export const ROLES_CAN_ADD_NOTES = ["admin","production_manager","head_of_sales","sales","production_staff"];
export const ROLES_CAN_UPLOAD = ["admin","production_manager","head_of_sales","sales","production_staff"];
export const ROLES_CAN_DELIVER = ["admin","production_manager","production_staff"];
export const ROLES_CAN_PAY = ["admin","production_manager","head_of_sales","sales"];
export const ROLES_CAN_REPAIR = ["admin","production_manager"];
export const ROLES_CAN_REWORK = ["admin","production_manager","head_of_sales"];
// Sales can only advance orders up to and including Deposit Paid
export const SALES_MAX_ADVANCE_TO = "Deposit Paid";
// Head of Sales: can approve credit up to 250,000 KES for reseller/commercial
export const HEAD_OF_SALES_CREDIT_LIMIT = 250000;
// Credit bypass: reseller + these payment terms can skip Deposit Paid
export const CREDIT_TERMS = ["30_day","60_day","custom"];
// Backward movement: source → target (production_manager, admin, head_of_sales only)
// Ready for Delivery goes back to Production (not QC — they've already passed QC, issue is in prep/packaging)
export const REWORK_TARGETS = {
  "Material Check":"Quote Approved",
...
// Returns workflow steps only (excludes terminal Cancelled/Refunded from progress bar)
export function getStatusList(type){return type==="repair"||type==="return"?REPAIR_STATUSES:STATUSES.filter(s=>s!=="Cancelled / Refunded")}
