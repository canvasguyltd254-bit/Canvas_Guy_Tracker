...
// workspaceActive — true when rendered inside the WorkspaceShell tab strip.
//   Adjusts the sticky header top to sit below the tab strip (92px) instead
...
export default function OrdersModule({ workspaceActive = false, refreshKey = 0 } = {}) {
  ...
  // Sticky top: 56px below app header normally, 92px when tab strip is visible.
  const stickyTop = workspaceActive ? '92px' : '56px';
