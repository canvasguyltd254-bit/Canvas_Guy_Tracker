...
CREATE POLICY "orders_insert" ON public.orders FOR INSERT WITH CHECK (
  auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales')
);
CREATE POLICY "orders_update" ON public.orders FOR UPDATE USING (
  auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales','production_staff')
);
...
CREATE POLICY "items_insert" ON public.order_items FOR INSERT WITH CHECK (auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales'));
CREATE POLICY "items_update" ON public.order_items FOR UPDATE USING (auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales'));
CREATE POLICY "items_delete" ON public.order_items FOR DELETE USING (auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales'));
...
CREATE POLICY "pay_insert" ON public.order_payments FOR INSERT WITH CHECK (auth.role() = 'authenticated' AND get_user_role() IN ('admin','production_manager','sales'));
